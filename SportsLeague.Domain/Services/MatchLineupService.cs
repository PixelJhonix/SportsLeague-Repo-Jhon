...
namespace SportsLeague.Domain.Services
{
    public class MatchLineupService : IMatchLineupService
    {
        ...
        public async Task<MatchLineup> AddPlayerToLineupAsync(int matchId, MatchLineup lineup)
        {
            ...
            // V2 + V3: El jugador debe existir y pertenecer al HomeTeam o AwayTeam
            // Reutilizamos MatchValidationHelper (patrón DRY de Fase 5)
            // ValidatePlayerInMatchAsync valida existencia del jugador (V2)
            // y que pertenece a uno de los dos equipos del partido (V3)
