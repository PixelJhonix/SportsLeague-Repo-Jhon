        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TournamentSponsor>(entity =>
            {
                ...
                entity.Property(ts => ts.ContractAmount)
                      .IsRequired()
                      .HasColumnType("decimal(18,2)");//18,2 se usa para una mejor precisión en valores monetarios, 18 dígitos en total y 2 decimales
            ...
            modelBuilder.Entity<MatchLineup>(entity =>
            {
                ...
                // Relación con Match: si se elimina el partido, se eliminan sus alineaciones
                entity.HasOne(ml => ml.Match)
                      .WithMany(m => m.Lineups)
                      .HasForeignKey(ml => ml.MatchId)
                      .OnDelete(DeleteBehavior.Cascade);

                // Relación con Player: NO eliminar al jugador si tiene alineaciones registradas
                ...
                // Mismo patrón que TournamentTeam (TournamentId + TeamId) de Fase 3
